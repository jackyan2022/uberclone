...
<div align="center">
  ...
  <h3 align="center">Uber like react native app</h3>
...
This project is a clone of the Uber react native app.

It is made using react native with expo and Google Map API.
...
* [Google Map API](https://console.cloud.google.com/google/maps-apis/start)
...
1. Clone the repo
   ```sh
   git clone https://github.com/hebe889900/uberclone.git
   ```
2. Install NPM packages
   ```sh
   npm install
   ```
3. Request Google Map API KEY:
   ...
   3. Enable the following:
        ...
        Places API
        Distance Matrix API
   4. Go to credentials and copy the API Key then in the .env file paste it at GOOGLE_MAPS_APIKEY.
...
- [ ] Add display nearby drivers
- [ ] Add estimate time for driver arrive and trip
- [ ] Add payment
- [ ] Add real time location fetching for driver and trip
...
Your Name - [@your_twitter](https://twitter.com/hebe889900) - jackyan63@gmail.com

Project Link: [https://github.com/hebe889900/uberclone](https://github.com/hebe889900/uberclone)
